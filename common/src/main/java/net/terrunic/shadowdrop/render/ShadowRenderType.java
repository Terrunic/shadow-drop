...
import net.terrunic.shadowdrop.mixin.accessor.RenderTypeAccessor;
...
public class ShadowRenderType extends RenderType {
    ...
    private static final Function<ResourceLocation, RenderType> SHADOW = Util.memoize(texture -> RenderTypeAccessor.invokeCreate(
        "shadowdrop_shadow",
        FORMAT,
